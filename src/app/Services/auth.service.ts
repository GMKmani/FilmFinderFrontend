...
export class AuthService {
  ...
  private apiUrl = 'https://filmfinder-9c48.onrender.com/api/users/login'; // Adjust URL as needed

  constructor( private http: HttpClient,private toast:ToastMessagesService,) { }

  register(user: User): Observable<any> {
    return this.http.post('https://filmfinder-9c48.onrender.com/api/users/register', user, {
