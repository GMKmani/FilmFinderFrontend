...
export class MovieService {
  ...
  baseUrl: string = "https://filmfinder-9c48.onrender.com/api/Movies";
  ...
  getAllMovies():Movie[]
  {
    let movieslit = this.http.get('https://filmfinder-9c48.onrender.com/api/Movies');   
    this.http.get('https://filmfinder-9c48.onrender.com/api/Movies').subscribe((response) => {
